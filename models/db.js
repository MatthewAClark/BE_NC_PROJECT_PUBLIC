...
const postDelay = (date_of_delay, expected_arrival_time, expected_departure_time, train_id) => db.one(`INSERT INTO delays (date_of_delay, expected_arrival_time, expected_departure_time, cancelled, train_id) VALUES ($1, $2, $3, false, $4) RETURNING *`, [date_of_delay, expected_arrival_time, expected_departure_time, train_id])
